  ...
  return (
    ...
    >
      <div className="mt-8 border rounded-lg p-6 leading-8">
        ℹ<b className="ml-4">브루클린에서 보는 환상적인 야경 워킹 투어</b>
        <br />
        원스 어폰 어 타임 인 아메리카, 무한도전 등 수많은 영화, 드라마, 예능의
        촬영지로 유명합니다. 맨하탄 브릿지, 페블비치, 제인 회전목마 등 멋진
        명소들과 밤하늘을 수놓는 맨하탄의 야경을 배경으로 멋진 사진을
        담아가세요!
        <br />
        맨하탄심장이 멎을 만한 맨하탄의 야경 모습을 맨하탄 스카이라인과 나란히
        있는 벤치에서 마음껏 즐기세요! 공원 입구에는 뉴욕 아이스크림 맛집인
        브루클린 아이스크림 팩토리나 애플 힐 크리머리도 있습니다. 공원 왼쪽
        끝으로가면 밤에도 밝게 빛나고 있는 자유의 여신상도 보실 수 있습니다.
        <br />
      </div>
